package view
{
    ...
    //import com.adobe.serialization.json.*;//as2使用此项
    import events.*;
    ...
    public class CutView extends Sprite
    {
        ...
        private function cancelProgramm(event:MouseEvent) : void
        {
			...
			ExternalInterface.call(Param.jsFunc, -1, null, Param.uid);
        ...
        private function uploadComplete(event:Event) : void
        {
            ...
            //var returnData = JSON.decode(_json);//as2使用此项
            var returnData = JSON.parse(_json);
            try
            {
                ExternalInterface.call(Param.jsFunc, 1 , returnData, Param.uid);
            }
            catch (e:Error)
            {
        ...
        public function addSaveBtns() : void
        {
            if (this.saveBtn == null)
            {
                ...
                this.saveBtn.y = this.cancleBtn.y = Param.pSize[1]+130;
